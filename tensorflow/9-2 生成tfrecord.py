...
_NUM_SHARDS = 5
# 数据集路径
DATASET_DIR = r"E:\SEU\CodeCpp-learning\tensorflow\slim\images"
# 标签文件名字
LABELS_FILENAME = r"E:\SEU\CodeCpp-learning\tensorflow\slim\images\labels.txt"

# 定义文件tfrecord文件的路径+名字
...
if __name__ == '__main__':
    if _dataset_exists(DATASET_DIR):
        ...
        # 把分类转化为字典格式 类似于{'house':3, 'flower',1}
